...
let hmac_suite =
  ...
  test_hmac_feed "MD5" `MD5 (List.combine md5_inputs md5_results) @
  test_hmac_feed "SHA1" `SHA1 (List.combine sha1_inputs sha1_results) @
  test_hmac_feed "SHA224" `SHA224 (List.combine sha2_inputs sha224_results) @
  test_hmac_feed "SHA256" `SHA256 (List.combine sha2_inputs sha256_results) @
  test_hmac_feed "SHA384" `SHA384 (List.combine sha2_inputs sha384_results) @
  test_hmac_feed "SHA512" `SHA512 (List.combine sha2_inputs sha512_results)
